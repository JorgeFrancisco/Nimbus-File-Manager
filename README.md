...
```text
Tests:       2081 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.93% instruction, 90.45% branch, 97.43% line, 98.32% method, 100.00% class
```
...
```text
Floor:  97.93% instruction, 90.45% branch, 97.43% line, 98.32% method, 100.00% class
