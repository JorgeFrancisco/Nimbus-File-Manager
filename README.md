...
```text
Tests:       1908 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.38% instruction, 89.47% branch, 97.00% line, 97.54% method, 100.00% class
```
...
```text
Floor:  97.38% instruction, 89.47% branch, 97.00% line, 97.54% method, 100.00% class
