...
```text
Tests:       2174 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      98.43% instruction, 91.70% branch, 98.03% line, 98.67% method, 100.00% class
```
...
```text
Floor:  98.43% instruction, 91.70% branch, 98.03% line, 98.67% method, 100.00% class
