...
```text
Tests:       1919 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.39% instruction, 89.50% branch, 97.01% line, 97.56% method, 100.00% class
```
...
```text
Floor:  97.39% instruction, 89.50% branch, 97.01% line, 97.56% method, 100.00% class
