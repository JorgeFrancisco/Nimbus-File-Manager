...
```text
Tests:       2321 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      98.45% instruction, 91.97% branch, 98.06% line, 98.73% method, 100.00% class
```
...
```text
Floor:  98.45% instruction, 91.97% branch, 98.06% line, 98.73% method, 100.00% class
