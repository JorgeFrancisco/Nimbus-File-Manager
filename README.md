...
```text
Tests:       2048 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.91% instruction, 90.33% branch, 97.41% line, 98.30% method, 100.00% class
```
...
```text
Floor:  97.91% instruction, 90.33% branch, 97.41% line, 98.30% method, 100.00% class
