...
```text
Tests:       2655 run, 0 failures, 0 errors, 10 skipped
JaCoCo:      98.48% instruction, 92.23% branch, 98.00% line, 98.89% method, 100.00% class
```
...
```text
Floor:  98.46% instruction, 92.23% branch, 97.97% line, 98.88% method, 100.00% class
