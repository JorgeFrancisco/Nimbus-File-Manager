...
```text
Tests:       2063 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.92% instruction, 90.39% branch, 97.41% line, 98.31% method, 100.00% class
```
...
```text
Floor:  97.92% instruction, 90.39% branch, 97.41% line, 98.31% method, 100.00% class
