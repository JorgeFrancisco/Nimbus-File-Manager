...
```text
Tests:       2065 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.92% instruction, 90.43% branch, 97.42% line, 98.31% method, 100.00% class
```
...
```text
Floor:  97.92% instruction, 90.43% branch, 97.42% line, 98.31% method, 100.00% class
