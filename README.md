...
```text
Tests:       1998 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.84% instruction, 90.14% branch, 97.31% line, 98.19% method, 100.00% class
```
...
```text
Floor:  97.84% instruction, 90.14% branch, 97.31% line, 98.19% method, 100.00% class
