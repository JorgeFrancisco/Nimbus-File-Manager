...
```text
Tests:       1990 run, 0 failures, 0 errors, 9 skipped
JaCoCo:      97.84% instruction, 90.12% branch, 97.31% line, 98.19% method, 100.00% class
```
...
```text
Floor:  97.84% instruction, 90.12% branch, 97.31% line, 98.19% method, 100.00% class
Goal:   98.00% instruction, 90.00% branch, 98.00% line, 98.00% method, 100.00% class
```

Branch, method and class are **at the goal**; instruction and line are **87
instructions and 73 lines** away from theirs. Branch and method need a new target
