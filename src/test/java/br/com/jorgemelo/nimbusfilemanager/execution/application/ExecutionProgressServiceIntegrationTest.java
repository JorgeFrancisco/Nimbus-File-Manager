...
class ExecutionProgressServiceIntegrationTest {
	...
	void rejectingMovesTheRowItselfAndNotOnlyTheHistory() {
		...
		executionProgressService.reject(Takings.owning(running.getId()), ExecutionMessages.executionSuperseded());
	...
	void failingMovesTheRowItselfAndNotOnlyTheHistory() {
		...
		executionProgressService.fail(Takings.owning(running.getId()), ExecutionMessages.executionInterrupted());
	...
	void interruptingMovesTheRowItselfAndNotOnlyTheHistory() {
		...
		executionProgressService.interrupt(Takings.owning(running.getId()), ExecutionMessages.executionInterrupted());
