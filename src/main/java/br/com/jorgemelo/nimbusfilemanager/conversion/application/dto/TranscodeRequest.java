 ...
 * progress into a percentage, and to prove afterwards that the converted file
 * is not truncated. Null for a video whose duration was never extracted
 * @param sourceIsHevc the video stream is already H.265, so only the container
 * changes and the video is remuxed instead of re-encoded
 */
