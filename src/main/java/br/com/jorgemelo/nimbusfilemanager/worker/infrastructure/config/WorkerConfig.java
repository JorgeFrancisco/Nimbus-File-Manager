...
import br.com.jorgemelo.nimbusfilemanager.worker.application.ExecutionReclaimScheduler;
...
public class WorkerConfig {
	...
	private final ExecutionReclaimScheduler executionReclaimScheduler;
	...
	public WorkerConfig(WorkerLoop workerLoop, SchemaCompatibility schemaCompatibility,
			...
			ExecutionReclaimScheduler executionReclaimScheduler, ExecutionQueueSignals executionQueueSignals,
		...
		this.executionReclaimScheduler = executionReclaimScheduler;
	...
	void startClaiming() {
		...
		// The same rule then runs on a timer, because a lease that had time left at
		// this moment expires later and nobody would look again.
		executionReclaim.reclaimAbandoned();

		executionReclaimScheduler.start();
