 ...
 *
 * <p>
 * The ownership argument is ignored on purpose: nothing here writes to the
 * library. What it produces is a description of what a run would do.
 */
@Component
public class OrganizationPreviewJobHandler implements ExecutionJobHandler {
	...
	public void handle(Execution execution, ClaimedExecution claimed, ExecutionOwnership ownership) {
		...
		organizationPreviewJob.run(request, execution);
	}
