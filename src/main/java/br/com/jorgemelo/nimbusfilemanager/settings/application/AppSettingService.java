...
public class AppSettingService implements ApplicationRunner {
	...
	private List<AppSettingDefinition> definitions(NimbusFileManagerProperties properties) {
		return List.of(new AppSettingDefinition(SettingsConstants.TIMEZONE, SettingsConstants.DEFAULT_TIMEZONE,
				...
				new AppSettingDefinition(SettingsConstants.API_MAX_FOLDER_LIMIT,
						intDefault(properties.api(), Api::maxFolderLimit), VALUE_TYPE_INTEGER,
						"Limite máximo de pastas nas estatísticas, em pastas."),
				...
				new AppSettingDefinition(SettingsConstants.BOUNDARY_GBOPEN_API_URL,
						"https://www.geoboundaries.org/api/current/gbOpen/", VALUE_TYPE_STRING,
				...
				new AppSettingDefinition(SettingsConstants.BOUNDARY_AUTO_UPDATE_ENABLED, VALUE_TRUE, VALUE_TYPE_BOOLEAN,
				...
				new AppSettingDefinition(SettingsConstants.MAP_TILE_URL,
						"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", VALUE_TYPE_STRING,
