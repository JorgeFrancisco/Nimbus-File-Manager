 ...
 * can express - {@code ?from=2008-01-01&minLongestSide=1920}. The grouped value
 ...
 * the way in, once.
 */
public record TimelineFilterForm(LocalDate from, LocalDate to, String manufacturer, String model, Long minSizeMb,
