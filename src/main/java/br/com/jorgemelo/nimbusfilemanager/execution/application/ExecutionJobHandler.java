 ...
 * {@link ExecutionOwnership#assertStillOwned()} between batches and immediately
 * before each irreversible write. A handler that only reads has nothing to
 * guard and need not ask.
 */
